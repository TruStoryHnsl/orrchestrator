...
var Shell = (function() {
  ...
  function openWebSocket() {
    ...
    ws.onopen = function() {
      // Push the most recent fit dims so the PTY matches the browser
      // viewport. Tools inside the PTY (vim / tmux / fzf) use these
      // dims to render correctly. xterm.js reports cols/rows after
